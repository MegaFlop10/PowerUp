...
public class RightSwitchRight extends AutoMode {
	...
	public void runStep(int stepIndex) {
		...
		switch (stepIndex) {
			case 0:
				...
				Drivetrain.getInstance().actionSensorDrive(0.6, -30, 2.75);
				break;
	...
	public boolean getStepIsCompleted(int stepIndex) {
		...
		switch (stepIndex) {
			case 0:
				return Drivetrain.getInstance().getEncoderWithinDistance(2.75, 0.1);
